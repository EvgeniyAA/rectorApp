...
class TreeAdapter(
    ...
    private val data: MutableList<SelectionCommitteeElement>,
    private val onItemSelected: (item: SelectionCommitteeElement) -> Unit,
    private val onItemChecked: (item: SelectionCommitteeElement) -> Unit
    ...
    fun replaceData(newData: List<SelectionCommitteeElement>) {
    ...
    class TreeDiffUtills(val newData: List<SelectionCommitteeElement>, val oldData: List<SelectionCommitteeElement>) : DiffUtil.Callback() {
        ...
        override fun areContentsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean =
            oldData[oldItemPosition].isCollapsed == newData[newItemPosition].isCollapsed &&
                    oldData[oldItemPosition].isFavorite == newData[newItemPosition].isFavorite &&
                    oldData[oldItemPosition].needToShow == newData[newItemPosition].needToShow &&
                    oldData[oldItemPosition].id == newData[newItemPosition].id
    }

    private inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bind(item: SelectionCommitteeElement) {
            ...
            with(itemView) {
                ...
                when (item.elementType) {
                    ElementType.CHILD_DATA, ElementType.AFTER_PARENT_DATA -> {
