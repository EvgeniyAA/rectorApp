...
class StaffTreeAdapter(
    private val editable: Boolean = false,
    private val data: MutableList<StaffHierarchyItem>,
    private val onItemSelected: (item: StaffHierarchyItem) -> Unit,
    private val onItemChecked: (item: StaffHierarchyItem) -> Unit
    ...
    fun replaceData(newData: List<StaffHierarchyItem>) {
    ...
    class TreeDiffUtills(val newData: List<StaffHierarchyItem>, val oldData: List<StaffHierarchyItem>) : DiffUtil.Callback() {
    ...
    private inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bind(item: StaffHierarchyItem) {
